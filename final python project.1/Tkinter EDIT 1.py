...
con = m.connect(user = 'root',host = 'localhost',passwd = '123password456',database = 'app')
cursor = con.cursor()
s = smtplib.SMTP('smtp.gmail.com',587)
s.starttls()
s.login('aalascare@gmail.com','123password456')
x=0
um =am=em = ''
def menu():
        global Mainmenu
...
def bar():
    global progress
    progress=ttk.Progressbar(signupmain,orient=HORIZONTAL,length=100,mode='indeterminate')
...
def mainaftersignup():
        ...
        try:    
                    ...
                    already = Label(signupmain,text='Username alraedy taken or Incorrect Email',bg='black',fg='white')
...
aalaslabel=Label(rframe1,text='AALAS CARE',bg='black',fg='white')
